    ...
    // ============ 第 20 课：收官与全局思路 ============
    {
      ...
      steps: [
        ...
        },
        {
          type: 'demo',
          frames: [
            { board: 'B 3,3 W 7,7', text: '<b>布局：</b>双方棋子还没有接触。黑棋占左上角 C7，白棋占右下角 G3；这时最值钱的是角和边。', mark: 20, duration: 2000 },
            { board: 'B 3,3 3,7 W 7,7 7,3', text: '<b>布局：</b>双方继续拆边扩张。此时不要急着在中央打架，先让自己的棋有落脚点。', mark: 24, duration: 2000 },
            { board: 'B 3,3 3,4 3,6 3,7 W 4,4 4,6', text: '<b>中盘：</b>黑白棋开始接触。黑棋中间的 E7 是断点，局面的重点不再是“多占一个角”，而是先别被切断。', highlights: [{ i: 22, label: '断点' }], duration: 2400 },
